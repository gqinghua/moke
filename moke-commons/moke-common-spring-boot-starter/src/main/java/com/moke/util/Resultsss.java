...
public class Resultsss<T> implements Serializable {
...
//	}
//
//	private Resultsss(IResultCode resultCode) {
//		this(resultCode, null, resultCode.getMsg());
//	}
//
//	private Resultsss(IResultCode resultCode, String msg) {
//		this(resultCode, null, msg);
//	}
//
//	private Resultsss(IResultCode resultCode, T data) {
//		this(resultCode, data, resultCode.getMsg());
//	}
//
//	private Resultsss(IResultCode resultCode, T data, String msg) {
//		this(resultCode.getCode(), data, msg);
//	}
//
//	private Resultsss(int code, T data, String msg) {
//		this.code = code;
//		this.data = data;
//		this.msg = msg;
//		this.time = System.currentTimeMillis();
