package com.moke.member.service.impl;

import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.moke.common.exception.ApiMallPlusException;
import com.moke.common.exception.BusinessException;
import com.moke.common.entity.ums.UmsMember;
import com.moke.common.utils.CommonResult;
import com.moke.common.vo.SmsCode;
import com.moke.member.config.WxAppletProperties;
import com.moke.common.entity.ums.Sms;
import com.moke.member.mapper.SysAreaMapper;
import com.moke.member.mapper.UmsMemberMapper;
import com.moke.member.mapper.UmsMemberMemberTagRelationMapper;
import com.moke.member.service.IUmsMemberLevelService;
import com.moke.member.service.IUmsMemberService;
import com.moke.member.service.RedisService;
import com.moke.member.service.SmsService;
import com.moke.member.utils.CharUtil;
import com.moke.member.utils.CommonUtil;
...
public class UmsMemberServiceImpl extends ServiceImpl<UmsMemberMapper, UmsMember> implements IUmsMemberService {
    ...
    public CommonResult generateAuthCode(String telephone) {
        ...
        return new CommonResult().success("获取验证码成功", sb);
    }
    ...
    public Object loginByWeixin(HttpServletRequest req) {
        try {
            ...
            JSONObject sessionData = com.moke.util.CommonUtil.httpsRequest(requestUrl, "GET", null);

            if (null == sessionData || StringUtils.isEmpty(sessionData.getStr("openid"))) {
                throw new BusinessException("登录失败");
            }
            //验证用户信息完整性
            String sha1 = com.moke.util.CommonUtil.getSha1(userInfos + sessionData.getStr("session_key"));
    ...
    @Override
    @Transactional
    public CommonResult updateMembershowStatus(Long id, Integer status) {
        UmsMember umsMember = memberMapper.selectById(id);
        if (umsMember==null){
            return new CommonResult().failed("查询无此人");
        }
        umsMember.setStatus(status);
        int selectone = memberMapper.updateById(umsMember);
        if (selectone==1){
