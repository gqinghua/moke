package com.moke.generator.service.impl;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.moke.generator.mapper.SysGeneratorMapper;
import com.moke.generator.service.SysGeneratorService;
import com.moke.generator.utils.GenUtils;
...
//        return PageResult.<Map<String, Object>>builder().data(list).code(0).count(page.getTotal()).build();
        return PageResult.builder().data(Collections.singletonList(list)).code(0).count(page.getTotal()).build();
    }
