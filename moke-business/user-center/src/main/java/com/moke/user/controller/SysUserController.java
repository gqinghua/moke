...
import com.moke.common.utils.ExcelUtil;
import com.moke.common.utils.ValidatorUtils;
import com.moke.user.model.SysUserExcel;
import com.moke.user.service.ISysRoleService;
import com.moke.user.service.ISysUserService;
...
public class SysUserController {
    ...
    public Object getUserByPage(SysUser entity,
        ...
        try {
            IPage<SysUser> page = appUserService.page(new Page<SysUser>(pageNum, pageSize), new QueryWrapper<>(entity).orderByDesc("create_time"));
...
//    @ResponseBody
    ...
    @GetMapping("/sys/sysUser/users/updateEnabled")
    @ApiImplicitParams({
