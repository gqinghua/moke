...
import com.moke.oauth.mobile.MobileAuthenticationToken;
import com.moke.oauth.openid.OpenIdAuthenticationToken;
...
public class OAuth2Controller {
    ...
    @ApiOperation(value = "用户名密码获取token",httpMethod = "POST")
